...
<body>
	...
	<div class="container">
		...
		<div>
			...
			<h3 class="fontstyle">Uploaded File
			<br>
...
<!-- 		<br/> -->
<!-- 		<br/> -->
		<table border="3" width="100" height="100"  cellspacing="1" cellpadding="20" bordercolor="orange">
		...
		<tr>
		<td>
		<p class="fontstyle"> ${image.imageid}</p><br/>
		</td>
		<td>
		<p class="fontstyle"> ${image.user.userid}</p><br/>
		</td>
		<td>
		<p class="fontstyle">${image.filePath}</p><br/>
		</td>
		<td>
		<p class="fontstyle">${image.fileName}</p><br/>
		</td>
		<td>
		<p class="fontstyle"><img alt="pictures" src="<%=request.getContextPath()%>/${out}"/></p>
		</td>
		</tr>
		</tbody>
		</table>
