...
<!-- 						<td><a href="newuser"> Add</a></td> -->
						<td><input type=button onClick="window.location='getuser?userid=${user.userid}';" value='Update User'></td>
						<td><input type=button onClick="window.location='deleteuser?userid=${user.userid}';" value='Delete User'></td>
						<td><input type=button onClick="window.location='newuser';" value='Add new User'></td>
						<td></td>
					</tr>
				</tbody>
			</c:forEach>
