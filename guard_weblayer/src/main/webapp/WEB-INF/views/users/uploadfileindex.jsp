...
<body>
	...
	<div class="container">
		...
		<ul id="nav">
			...
			<li><a href="<c:url value="/j_spring_security_logout" />"> <p class="fontstyle">Log Out</p>
			</a></li>
			<li><a style="font-size: 20px; color: #19BCFF;"><p class="fontstyle">${currentUser.username}</p></a></li> 
			<div id="lavalamp"></div>
		</ul>
		<br /> <br /> <br />
