			...
			<ul class="image_gallery">
				<c:forEach items="${imageList}" var="images">
					<li><a style="text-decoration: none; cursor: pointer;"
						onclick="location.href='singelImage?userid=${images.user.userid}'">
							<img alt="pictures"
							src="<c:url value='${request.contextPath}/image/${images.imageid}'/>" /><br />
							${images.user.userid} ${images.user.username}
							${images.user.lastname}<br />
					</a></li>
