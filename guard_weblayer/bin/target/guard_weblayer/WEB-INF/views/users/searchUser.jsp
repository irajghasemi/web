	...
	<div class="container">
		...
		<div id="buttonContainer">
			<form action="findUserById" method="get">
				<p class="fontstyle">
					<label for="userid">User Id </label> <br /> <input name="userid"
						style="" required="required" maxlength="45" placeholder="userid"
						size="45" />
				...
				<button class="button small blue " type="submit"
					onClick="window.location='foundedUser';">Search</button>
				<br />
				<br />
			</form>
		</div>
