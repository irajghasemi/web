...
<body>
	...
	<div class="container">
		...
		<div>
			...
			<h1 class="font2">Admin Has Successfuly Been Added</h1>
			<br />
			<p class="fontstyle">First Name : ${admin.firstname}</p>
			<p class="fontstyle">Last Name : ${admin.lastname}</p>
			<p class="fontstyle">Password : ${admin.password}</p>
			<p class="fontstyle">Email : ${admin.email}</p>
			<p class="fontstyle">Street : ${admin.address.street}</p>
			<p class="fontstyle">Zip Code :${admin.address.zipcode}</p>
			<p class="fontstyle">City : ${admin.address.city}</p>
		</div>
