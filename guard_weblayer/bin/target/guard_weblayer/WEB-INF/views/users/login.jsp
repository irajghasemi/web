...
<body>
	...
	<div class="container">
		...
		<ul id="nav">
			...
			<li><a
				href="<c:url value="http://localhost:8080/guard_weblayer/addnewuser/" />">Register</a></li>
		...
		<div>
			<table id="buttonContainer" align="center" cellpadding="10"
							...
							<form action="<c:url value='j_spring_security_check' />"
								...
								<fieldset>
									...
									<label for="username">User-Name:</label> <input name="username"
										style="" required="required" maxlength="45"> <label
										for="password">Password:</label> <input name="password"
										style="" /  required="required" maxlength="45">
