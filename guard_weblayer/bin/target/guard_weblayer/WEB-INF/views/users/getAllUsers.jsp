				...
				<tbody class="fontstyle">
					<c:forEach var="user" items="${allUsers}">
						<tr valign="baseline" align="left">
							...
							<!-- <td> -->
							<%-- <a style="text-decoration: none ;cursor: pointer;" onClick="window.location='deleteuser?userid=${user.userid}';"> --%>
							<%-- 			<img  size="10" alt="delete" src="<%=request.getContextPath()%>/resources/images/trashes.png"> </a></td> --%>
							<td><button class="button small blue " type="submit"
