	...
	<div class="container">
		...
		<table border="3" width="100" height="100" cellspacing="1"
			...
			<tbody align="left" valign="top">
				<tr>
					<td>//error.jsp <%@ page isErrorPage="true"%>
						<%-- 		<img alt="404 error" src="<%=request.getContextPath()%>/error-404.jpg"/> --%>
						<img alt="404 error"
						src="<c:url value='${request.contextPath}/${error-404.jpg }'/>" />
						${notfound} ${message}
					</td>
					<td><footer> </footer> <!-- JavaScript includes --> <script
