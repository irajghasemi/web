				...
				<table border="0" bgcolor="121212" align="left" cellpadding="10"
					...
					<tbody>
						<tr align="center" valign="baseline">
							...
							<td><input name="username" style="" required="required"
								maxlength="45" placeholder="${getuserforupdate.username}" /></td>
							<td><input name="password" style="" /  required="required"
								maxlength="45" placeholder="${getuserforupdate.password}">
							</td>
							<td><input name="street" style="" required="required"
								maxlength="45" placeholder="${getuserforupdate.address.street}" />
							</td>
							<td><input name="zipcode" style="" required="required"
								maxlength="45" placeholder="${getuserforupdate.address.zipcode}" /></td>
							<td><input name="city" style="" required="required"
								maxlength="45" placeholder="${getuserforupdate.address.city}" />
							</td>
							<td><button class="button blue medium " type="submit">Save</button>
							</td>
