...
<body>
	...
	<div class="container">
		...
		</br> </br> </br> </br> <font color="blue" size="14">
			<div id="buttonContainer">
				<form action="register" method="post" modelAttribute="user"
					style="font-family: verdana, helvetica, arial, sans-serif; width: 300px; font-size: 12px; line-height: 20px; margin-left: auto; margin-right: auto; border: 2px solid #1C1C1C; outline: 2px solid #1C1C1C; outline-offset: 10px;">

					<label for="Name">User Name </label> </br> <input name="username"
						style="" required="required" maxlength="45" placeholder="username" />
					<span class="form_hint">Proper format "name@something.com"</span> <br />
					...
					<br /> <label for="Street">Street</label> </br> <input
						name="address.street" style="" required="required" maxlength="45"
						placeholder="address.street" /> <br /> <label for="Zipcode">Zip
						Code</label> </br> <input name="address.zipcode" style="" required="required"
						maxlength="45" placeholder="address.zipcode" /> <br />
					<label for="City">City</label> </br> <input name="address.city" style=""
						required="required" maxlength="45" placeholder="city" /> <br />
					<br />
