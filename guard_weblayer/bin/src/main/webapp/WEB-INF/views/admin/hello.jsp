...
<body>
	...
	<div class="container">
		...
		<ul id="nav">
			...
			<font color="blue">
				<li><a><font color="blue" size="5">${username}</font></a></li>
				<div id="lavalamp"></div>
		</ul>
		</br> </br>
		<div>
			<font color="white">
				<h3>
					${message1} <font color="blue"><h2>${username}</h2></font>${message2}</h3>
				<%-- 				<font color="blue" ><h2>  ${username}</h2> </font> --%> <%-- 				<h3>${message2}</h3> --%>
		</div>
