...
<body>
	...
	<div class="container">
		...
		<div id="buttonContainer"
			style="overflow: auto; height: 1000px; width: 1150px">
			<form action="updateuser?userid=${getuserforupdate.userid}"
				method="post" modelAttribute="user" class="font3"
				style="width: 300px; font-size: 12px; margin-left: auto; margin-right: auto;">

				<p style="color: #19BCFF; font-size: 16px; font-style: italic;">
					<label for="firstname">First Name </label> <br /> <input
						name="firstname" required="required"
						value="${getuserforupdate.firstname}" size="45" /> <br /> <br />
					<label for="lastname">Last Name </label> <br /> <input
						name="lastname" required="required"
						value="${getuserforupdate.lastname}" size="45" /> <br /> <br />
					<label for="username">User Name </label> <br /> <input
						name="username" required="required"
						value="${getuserforupdate.username}" size="45" /> <br /> <br />
					<label for="password">Password </label> <br /> <input
						name="password" required="required"
						value="${getuserforupdate.password}" size="45" /> <br /> <br />
					<label for="email">Email </label> <br /> <input name="email"
						required="required" value="${getuserforupdate.email}" size="45" />
					<br /> <br /> <label for="Street">Street</label> <br /> <input
						name="street" required="required" maxlength="45"
						value="${address.street}" size="45" /> <br /> <br />
					<label for="Zipcode">Zip Code</label><br /> <input name="zipcode"
						required="required" maxlength="45" value="${address.zipcode}"
						size="45" /> <br /> <br />
					<label for="City">City</label> <br /> <input name="city"
						required="required" maxlength="45" value="${address.city}"
						size="45" />
				</p>
				<br />
